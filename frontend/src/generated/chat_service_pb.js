...
goog.exportSymbol('proto.chatservice.JoinReq', null, global);
 ...
 * @constructor
 */
proto.chatservice.JoinReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.chatservice.JoinReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.chatservice.JoinReq.displayName = 'proto.chatservice.JoinReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {number}
 */
proto.chatservice.ChannelMsg.prototype.getTs = function() {
 ...
 * @return {!proto.chatservice.ChannelMsg} returns this
 */
proto.chatservice.ChannelMsg.prototype.setTs = function(value) {
 ...
 * @return {number}
 */
proto.chatservice.PrivateMsg.prototype.getTs = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.chatservice.PrivateMsg} returns this
 */
proto.chatservice.PrivateMsg.prototype.setTs = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {!Object}
 */
proto.chatservice.JoinReq.prototype.toObject = function(opt_includeInstance) {
  return proto.chatservice.JoinReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.chatservice.JoinReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.chatservice.JoinReq.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.chatservice.JoinReq}
 */
proto.chatservice.JoinReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.chatservice.JoinReq;
  return proto.chatservice.JoinReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.chatservice.JoinReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.chatservice.JoinReq}
 */
proto.chatservice.JoinReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.chatservice.JoinReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.chatservice.JoinReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.chatservice.JoinReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.chatservice.JoinReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.chatservice.JoinReq.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.chatservice.JoinReq} returns this
 */
proto.chatservice.JoinReq.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
